                ...
                <table class="table text-center">
                    ...
                    <tbody>
                        ...
                        @forelse ($pesanan_details as $pesanan_detail)
                            <tr>
                                <td>{{ $no++ }}.</td>
                                <td><img src="{{url ('assets/sepatu')}}/{{ $pesanan_detail->product->gambar}}" class="img-fluid" width="200">
                                </td>
                                <td>
                              ...
                              {{$pesanan_detail->ukuran}} 
                                ...
                                <td>
                                    @if($pesanan_detail->saddle)
                                    {{$pesanan_detail->saddle}}
                                    <br>
                                    @else 
                                    -
                                    @endif
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                <a href="{{route('checkout')}}" class="btn btn-success btn-block">
                                    <i class="fas fa-arrow-right"></i> Check Out </a>
                            </td>
                        </tr>
                        @endif
