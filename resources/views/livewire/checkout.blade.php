            ...
            <div class="col">
                ...
                <form wire:submit.prevent="checkout"> 
                    ...
                    <div class="form-group">
                        ...
                        <textarea rows="2" class="form-control @error('alamat') is-invalid @enderror" wire:model="alamat"></textarea>
                                    @error('alamat')
                                    <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                    </span>
                    ...
                    <button class="btn btn-success btn-block" type="submit"><i class="fas fa-arrow-right"></i> Check Out </button>
